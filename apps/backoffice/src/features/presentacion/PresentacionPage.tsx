...
/* ---------------- Imágenes (public/imagenes del backoffice) ---------------- */
...
/**
 * Página PÚBLICA (sin sesión) que presenta qué es Amena. Redacción para público general. Diseño
 * visual con las fotos del comedor/platillos: hero con carrusel, galería y banners; navbar de
 * vidrio esmerilado. Responsive (móvil / tablet / escritorio). Solo lectura.
 */
