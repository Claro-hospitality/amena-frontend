...
import { aISO, deISO, horaCorta } from '@amena/utils'
import { useMisConsumosDelMes } from './queries'
...
/**
 * Historial de comidas del usuario logueado: un CALENDARIO que marca los días en que tuvo
 * consumo (navegable por mes); al presionar un día con consumo, muestra la hora en una card
 * flotante. Los datos se acotan a los comensales del propio usuario.
 */
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="mt-1 text-xs text-muted-foreground">
              ...
              <span className="capitalize">{mes.toLocaleDateString('es-MX', { month: 'long' })}</span>
            </span>
          </div>
